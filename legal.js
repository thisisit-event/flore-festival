...
(function () {
  ...
  var CSS = [
    ...
    '.lgl-link:hover{color:var(--sun,#FFC42E)}',
    ...
    '.lgl-close:hover{background:var(--sun,#FFC42E);transform:rotate(90deg)}',
    '.lgl-body{overflow-y:auto;padding:44px 38px 34px;-webkit-overflow-scrolling:touch}',
    '.lgl-kicker{font-family:\'Bricolage Grotesque\',system-ui,sans-serif;font-weight:700;font-size:.74rem;letter-spacing:.12em;text-transform:uppercase;color:var(--sun-deep,#F0A81C);margin-bottom:10px}',
    ...
    '.lgl-body li::before{content:"";position:absolute;left:0;top:9px;width:6px;height:6px;border-radius:50%;background:var(--sun,#FFC42E)}',
    ...
    '.lgl-cookie .ck-ok{font-family:\'Bricolage Grotesque\',system-ui,sans-serif;font-weight:700;font-size:.9rem;background:var(--sun,#FFC42E);color:var(--ink,#15395B);border:none;cursor:pointer;padding:11px 22px;border-radius:100px;transition:transform .2s,background .2s}',
    '.lgl-cookie .ck-ok:hover{transform:translateY(-2px);background:var(--sun-deep,#F0A81C)}',
